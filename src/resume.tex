...
\begin{center}
    ...
    \small 
    \faPhone{} {+91 0123456789} \hspace{12pt} % Adjust the value as needed
    \faIcon{github}
    \href{https://github.com/abhiphile}{GitHub} \hspace{12pt} % Adjust the value as needed
    \faIcon{linkedin}
    \href{https://www.linkedin.com/in/abhishek-kumar-nitdelhi/}{Linkedin} \hspace{12pt} % Adjust the value as needed
    \faIcon{envelope}
    \href{mailto:abhishek.nitdelhi@gmail.com}
    {\underline{abhishek.nitdelhi@gmail.com}} \hspace{12pt} % Adjust the value as needed
    \faIcon{globe}
...
\begin{itemize}[leftmargin=0.15in, label={}]
    \resumeItemListStart
        \resumeItem{{Selected in \textbf{Google Summer of Code (GSoC) 2024}, standing out among \textbf{43,984} applicants from \textbf{172 countries} for contributions to open-source projects. \textbf{ Top 0.02\%}}}\\
        \resumeItem{Acquired proficiency in advanced algorithms and data structures on LeetCode, attaining a rating of \textbf{1600+} and successfully solving \textbf{500+} questions.}\\
        \resumeItem{Secured a rank 32 in CodeRush coding competion.}
    \resumeItemListEnd
\end{itemize}
